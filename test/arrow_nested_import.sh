...
psql_run "CREATE TABLE na (id int, ia int[], ta text[], c nic) USING columnar;"
...
check "export rows" "$(q "SELECT columnar.export_arrow('na', '$AF');")" "5000"
psql_run "CREATE TABLE na2 (id int, ia int[], ta text[], c nic) USING columnar;"
check "import rows" "$(q "SELECT columnar.import_arrow('na2', '$AF');")" "5000"
...
psql_run "SELECT columnar.export_arrow('na', '$AF');"
psql_run "TRUNCATE na2;"
psql_run "SELECT columnar.import_arrow('na2', '$AF');"
